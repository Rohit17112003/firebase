      ...
      <div className="w-full">
        <div className=" sm:grid grid-cols-1 sm:grid-cols-2 flex flex-col-reverse gap-5  w-full">
          <div className=" flex flex-col  gap-[1.1rem] sm:mt-0 -mt-20">
            ...
            <div className="pb-0 sm:pb-0 md:pb-8 lg:pb-0 flex flex-wrap sm:flex-nowrap gap-8 sm:gap-5 w-full  mt-4">
              <div className="mt-2 mb-12 sm:mb-0 w-full ">
                <div className="grid grid-cols-2  sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-5 sm:gap-5 w-full">
                  {productList?.map((data, index) => {
                    ...
                    return (
                      <div
                        ...
                        className={` ${
                          index === 2 && "col-span-2"
                        } h-[6.5rem] w-full rounded-lg p-1 text-black ${bg} sm:text-start text-center shadow shadow-gray-600 w-full`}
                      >
                        <div className="w-full">
          ...
          <div className="flex sm:items-end sm:justify-end h-[26rem] sm:h-[35rem] -mt-12 sm:-mt-4 ">
            ...
            />
            <div class="w-full h-full mt-16 rounded-lg  overflow-hidden">
              <a href="https://ibb.co/QmLL5BZ">
                <img
                className=" rounded-lg shadow shadow-gray-400"
                  src="https://i.ibb.co/LpmmGwM/IMG-20241219-131315.jpg"
                  alt="IMG-20241219-131315"
                  border="0"
                />
              </a>
            </div>
